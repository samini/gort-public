 ...
 * @author shahriyar
 */
public class TransmitsDeviceSerialNumber extends AbstractDynamicHeuristic {
    ...
    public TransmitsDeviceSerialNumber() {
        super(NAME, SUMMARY);
    }

    public TransmitsDeviceSerialNumber(Project project, FileObject apk, Traversal traversal) {
        this();
    ...
    public AbstractDynamicHeuristic getInstance(Project project, FileObject apk, Traversal traversal) {
        return new TransmitsDeviceSerialNumber(project, apk, traversal);
    }
    ...
    public void onTransmissionTaintLog(TaintLog t) {
        ...
        if (TaintHelper.checkTag(taintTag, TaintHelper.TAINT_DEVICE_SN)) {
            output = true;
