 ...
 * @author shahriyar
 */
public class SetAppDebugMode extends AbstractStaticHeuristic {

    public static final String NAME = "Can Set App Debug Mode";
    public static final String SUMMARY = "Has the ability to set other apps to debug mode.";
    public static final String[] PERMISSIONS = {
        AndroidPermissions.SET_DEBUG_APP
    };
    
    public SetAppDebugMode() {
        super(NAME, SUMMARY);
    }
