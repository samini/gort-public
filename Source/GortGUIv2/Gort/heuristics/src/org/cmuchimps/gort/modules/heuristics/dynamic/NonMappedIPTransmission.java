 ...
 * @author shahriyar
 */
public class NonMappedIPTransmission extends AbstractDynamicHeuristic {
    public static final String NAME = "Transmits Sensitive Data to Non-Mapped IP";
    public static final String SUMMARY = "App transmits sensitive data to " + 
            "non-mapped ip address, i.e., the IP is not associated with a domain name.";
    
    private boolean output = false;
    
    public NonMappedIPTransmission() {
        super(NAME, SUMMARY);
    }

    public NonMappedIPTransmission(Project project, FileObject apk, Traversal traversal) {
        this();
    ...
    public AbstractDynamicHeuristic getInstance(Project project, FileObject apk, Traversal traversal) {
        return new NonMappedIPTransmission(project, apk, traversal);
    }
