 ...
 * @author shahriyar
 */
public class SendAndObfuscateSMS extends AbstractStaticHeuristic {

    public static final String NAME = "Can Send And Obfuscate SMS";
    public static final String SUMMARY = "Has the ability to send and obfuscate SMS.";
    public static final String[] PERMISSIONS = {
        AndroidPermissions.SEND_SMS,
        AndroidPermissions.WRITE_SMS
    };
    
    public SendAndObfuscateSMS() {
        super(NAME, SUMMARY);
    }
