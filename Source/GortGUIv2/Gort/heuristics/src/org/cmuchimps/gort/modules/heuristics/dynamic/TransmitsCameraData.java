 ...
 * @author shahriyar
 */
public class TransmitsCameraData extends AbstractDynamicHeuristic {
    public static final String NAME = "Transmits User's Camera Data";
    public static final String SUMMARY = "App transmits user's camera data.";
    
    private boolean output = false;
    
    public TransmitsCameraData() {
        super(NAME, SUMMARY);
    }

    public TransmitsCameraData(Project project, FileObject apk, Traversal traversal) {
        this();
    ...
    public AbstractDynamicHeuristic getInstance(Project project, FileObject apk, Traversal traversal) {
        return new TransmitsCameraData(project, apk, traversal);
    }
    ...
    public void onTransmissionTaintLog(TaintLog t) {
        ...
        if (TaintHelper.checkTag(taintTag, TaintHelper.TAINT_CAMERA)) {
            output = true;
