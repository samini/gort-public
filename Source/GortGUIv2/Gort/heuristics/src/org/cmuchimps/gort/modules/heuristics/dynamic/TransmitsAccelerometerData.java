 ...
 * @author shahriyar
 */
public class TransmitsAccelerometerData extends AbstractDynamicHeuristic {
    public static final String NAME = "Transmits User's Accelerometer Data";
    public static final String SUMMARY = "App transmits user's accelerometer data.";
    
    private boolean output = false;
    
    public TransmitsAccelerometerData() {
        super(NAME, SUMMARY);
    }

    public TransmitsAccelerometerData(Project project, FileObject apk, Traversal traversal) {
        this();
    ...
    public AbstractDynamicHeuristic getInstance(Project project, FileObject apk, Traversal traversal) {
        return new TransmitsAccelerometerData(project, apk, traversal);
    }
    ...
    public void onTransmissionTaintLog(TaintLog t) {
        ...
        if (TaintHelper.checkTag(taintTag, TaintHelper.TAINT_ACCELEROMETER)) {
            output = true;
