 ...
 * @author shahriyar
 */
public class LeakContacts extends AbstractStaticHeuristic {

    public static final String NAME = "Can Leak Contacts";
    public static final String SUMMARY = "Has the ability to send out contacts information.";
