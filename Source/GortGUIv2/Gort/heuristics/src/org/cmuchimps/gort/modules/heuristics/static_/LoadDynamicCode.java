 ...
 * @author shahriyar
 */
public class LoadDynamicCode extends AbstractStaticHeuristic {

    public static final String NAME = "Load Dynamic Code";
    public static final String SUMMARY = "May dynamically loads code (DexClassLoader).";
    
    public LoadDynamicCode() {
        super(NAME, SUMMARY);
    }
