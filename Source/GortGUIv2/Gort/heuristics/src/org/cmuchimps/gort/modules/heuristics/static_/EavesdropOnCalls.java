 ...
 * @author shahriyar
 */
public class EavesdropOnCalls extends AbstractStaticHeuristic {

    public static final String NAME = "Can Eavesdrop On Calls";
    public static final String SUMMARY = "Has the ability to eavesdrop on phone calls.";
    public static final String[] PERMISSIONS = {
        AndroidPermissions.PROCESS_OUTGOING_CALLS,
        AndroidPermissions.RECORD_AUDIO,
        AndroidPermissions.INTERNET
    };
    
    public EavesdropOnCalls() {
        super(NAME, SUMMARY);
    }
