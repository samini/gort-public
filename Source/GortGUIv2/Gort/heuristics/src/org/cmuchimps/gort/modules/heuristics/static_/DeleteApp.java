 ...
 * @author shahriyar
 */
public class DeleteApp extends AbstractStaticHeuristic {

    public static final String NAME = "Can Delete App";
    public static final String SUMMARY = "Has the ability to delete other apps, i.e., has android.permission.DELETE_PACKAGES permission.";
    public static final String[] PERMISSIONS = {
        AndroidPermissions.DELETE_PACKAGES
    };
