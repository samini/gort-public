 ...
 * @author shahriyar
 */
public class NoSSLSensitiveTransmission extends AbstractDynamicHeuristic {
    public static final String NAME = "Sensitive Transmissions w/o SSL";
    public static final String SUMMARY = "App transmits sensitive data without using SSL.";
    
    private boolean output = false;
    
    public NoSSLSensitiveTransmission() {
        super(NAME, SUMMARY);
    }

    public NoSSLSensitiveTransmission(Project project, FileObject apk, Traversal traversal) {
        this();
    ...
    public AbstractDynamicHeuristic getInstance(Project project, FileObject apk, Traversal traversal) {
        return new NoSSLSensitiveTransmission(project, apk, traversal);
    }
