 ...
 * @author shahriyar
 */
public class TransmitsUserHistory extends AbstractDynamicHeuristic {
    public static final String NAME = "Transmits User's History";
    public static final String SUMMARY = "App transmits user's history data (e.g., browser history).";
    
    private boolean output = false;
    
    public TransmitsUserHistory() {
        super(NAME, SUMMARY);
    }

    public TransmitsUserHistory(Project project, FileObject apk, Traversal traversal) {
        this();
    ...
    public AbstractDynamicHeuristic getInstance(Project project, FileObject apk, Traversal traversal) {
        return new TransmitsUserHistory(project, apk, traversal);
    }
    ...
    public void onTransmissionTaintLog(TaintLog t) {
        ...
        if (TaintHelper.checkTag(taintTag, TaintHelper.TAINT_HISTORY)) {
            output = true;
