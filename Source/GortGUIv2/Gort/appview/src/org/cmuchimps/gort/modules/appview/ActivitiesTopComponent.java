 ...
 */
@ConvertAsProperties(
        dtd = "-//org.cmuchimps.gort.modules.appview//Activities//EN",
        autostore = false)
@TopComponent.Description(
        preferredID = "ActivitiesTopComponent",
        //iconBase="SET/PATH/TO/ICON/HERE", 
        persistenceType = TopComponent.PERSISTENCE_ALWAYS)
@TopComponent.Registration(mode = "output", openAtStartup = false)
@ActionID(category = "Window", id = "org.cmuchimps.gort.modules.appview.ActivitiesTopComponent")
@ActionReference(path = "Menu/Window" /*, position = 333 */)
@TopComponent.OpenActionRegistration(
        displayName = "#CTL_ActivitiesAction",
        preferredID = "ActivitiesTopComponent")
@Messages({
    "CTL_ActivitiesAction=Activities",
    "CTL_ActivitiesTopComponent=Activities",
    "HINT_ActivitiesTopComponent=This is a Activities window"
})
public final class ActivitiesTopComponent extends TopComponent implements
        PropertyChangeListener {
    
    private static final String[] HEADERS = {"Name"};
    private StringTableModel model;

    public ActivitiesTopComponent() {
        initComponents();
        setName(Bundle.CTL_ActivitiesTopComponent());
        setToolTipText(Bundle.HINT_ActivitiesTopComponent());

        model = new StringTableModel(HEADERS);
        activitiesTableScrollPane.setModel(model);
        activitiesTableScrollPane.setTable(new JTable());
    ...
    private void initComponents() {
        ...
        activitiesTableScrollPane = new org.cmuchimps.gort.modules.tablewidgets.TableScrollPane();
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(activitiesTableScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 388, Short.MAX_VALUE)
                .addContainerGap())
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(activitiesTableScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 288, Short.MAX_VALUE)
                .addContainerGap())
        );
    }// </editor-fold>//GEN-END:initComponents

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private org.cmuchimps.gort.modules.tablewidgets.TableScrollPane activitiesTableScrollPane;
    ...
    private void update() {
        ...
        System.out.println("Updating app activities");
        ...
        try {
            ...
            List<Activity> activities = app.getActivies();
            String[][] data = new String[activities.size()][1];
            ...
            if (activities != null) {
                ...
                model.fireTableDataChanged();
                    ...
                    System.out.println("App has no associated activities: " + app.getName());
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
