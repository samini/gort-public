 ...
 * @author shahriyar
 */
public class AppResourceJustification extends AbstractCrowdTask {

    private static final String HEADER = "appname\tdescription\tscreenshot0\tscreenshot1\ttask\tresource\n";
    
    public AppResourceJustification(FileObject resultsFO, FileObject mTurkPropertiesFO,
    ...
    public AppResourceJustification(FileObject resultsFO, FileObject mTurkPropertiesFO,
        ...
        this(resultsFO, mTurkPropertiesFO,
                Installer.getCrowdTaskFile("Tasks/appresourcejustification.xml"),
    ...
    public static void writeInput(Writer writer, String name,
            ...
            String task, String resource) throws IOException {
        if (writer == null) {
            return;
        }
        
        StringBuilder row = new StringBuilder();
        row.append(String.format("%s\t%s\t%s\t%s\t%s\t%s\n", name, description,
                appScreenshot0, appScreenshot1, task, resource));
    ...
    public String getType() {
        return HIT.TYPE_RESOURCE_JUSTIFICATION;
    }
