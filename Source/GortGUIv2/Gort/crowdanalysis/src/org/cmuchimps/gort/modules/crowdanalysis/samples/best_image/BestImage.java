...
package org.cmuchimps.gort.modules.crowdanalysis.samples.best_image;
...
public class BestImage {
  ...
  public void createBestImage(String previewFile) {
    try {
      ...
      FileObject propertiesFO = Installer.getCrowdTaskFile("BestImage/best_image.properties");
      HITProperties props = null;
      if (propertiesFO != null && propertiesFO.canRead()) {
          props = new HITProperties(propertiesFO.getPath());
      } else {
          props = new HITProperties(propertiesFile);
      }
      
      FileObject questionFO = Installer.getCrowdTaskFile("BestImage/best_image.question");
      //Loading the question (QAP) file.  
      HITQuestion question = null;
      if (questionFO != null && questionFO.canRead()) {
          question = new HITQuestion(questionFO.getPath());
      } else {
          question = new HITQuestion(questionFile);
      }
   ...
   */
    ...
    BestImage app = new BestImage(null);
